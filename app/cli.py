...
def main(
    ...
    effective_url = api_url or os.environ.get("SHENAS_NET_URL", "https://shenas.net")
    os.environ["SHENAS_NET_URL"] = effective_url
    os.environ.setdefault("SHENAS_PACKAGE_INDEX", effective_url.rstrip("/"))
