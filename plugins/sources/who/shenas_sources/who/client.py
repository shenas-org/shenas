...
CORE_INDICATORS = {
    ...
    "GHED_CHEPCUSD_SHA2011": "Health expenditure per capita (USD)",
...
class WHOClient:
    ...
    def get_indicator(self, indicator_code: str) -> list[dict[str, Any]]:
        ...
        # Only get "both sexes" aggregate when sex dimension is present
        filters.append("(Dim1 eq 'BTSX' or Dim1 eq '' or Dim1 eq null)")
