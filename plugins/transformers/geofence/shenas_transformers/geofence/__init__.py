        ...
        return [
            {
                ...
                "type": "source_column",
                "required": False,
                "description": "Source column containing latitude",
                "default": "latitude",
            },
            {
                ...
                "type": "source_column",
                "required": False,
                "description": "Source column containing longitude",
                "default": "longitude",
            },
            {
                "name": "time_column",
                ...
                "type": "source_column",
                "required": False,
                "description": "Source column for arrival time",
            ...
            },
            {
                ...
                "type": "source_column",
                "required": False,
                "description": "Source column for departure time",
            ...
            },
            {
                ...
                "type": "target_column",
                "required": False,
                "description": "Target column for the place name",
                "default": "place_name",
            },
            {
                ...
                "type": "target_column",
                "required": False,
                "description": "Target column for the confidence score",
                "default": "confidence",
            },
            {
                "name": "id_expression",
