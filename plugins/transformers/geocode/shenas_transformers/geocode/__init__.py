    ...
    def param_schema(self) -> list[dict[str, Any]]:
        return [
            ...
            },
            {
                ...
                "label": "Latitude target column",
                "type": "target_column",
                "required": False,
                "description": "Column name for latitude in the target table",
                "default": "latitude",
                "role": "output_column",
            },
            {
                "name": "longitude_output",
                "label": "Longitude target column",
                "type": "target_column",
                "required": False,
                "description": "Column name for longitude in the target table",
                "default": "longitude",
                "role": "output_column",
            },
        ]
