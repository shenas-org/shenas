var Q=Object.defineProperty;var Y=(l,e,t)=>e in l?Q(l,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):l[e]=t;var c=(l,e,t)=>Y(l,typeof e!="symbol"?e+"":e,t);import{LitElement as v,css as b,html as n}from"lit";import V,{dagre as ee}from"cytoscape";import{Router as te}from"@lit-labs/router";class B extends v{constructor(){super(),this.open=!1,this.commands=[],this._query="",this._filtered=[],this._selectedIndex=0}updated(e){e.has("open")&&this.open&&(this._query="",this._selectedIndex=0,this._filter(),requestAnimationFrame(()=>{const t=this.renderRoot.querySelector("input");t&&t.focus()})),e.has("commands")&&this._filter()}_filter(){const e=this._query.toLowerCase();e?this._filtered=this.commands.filter(t=>t.label.toLowerCase().includes(e)||t.category.toLowerCase().includes(e)||(t.description||"").toLowerCase().includes(e)):this._filtered=this.commands,this._selectedIndex>=this._filtered.length&&(this._selectedIndex=Math.max(0,this._filtered.length-1))}_onInput(e){this._query=e.target.value,this._selectedIndex=0,this._filter()}_onKeydown(e){if(e.key==="ArrowDown")e.preventDefault(),this._filtered.length>0&&(this._selectedIndex=Math.min(this._selectedIndex+1,this._filtered.length-1)),this._scrollToSelected();else if(e.key==="ArrowUp")e.preventDefault(),this._selectedIndex=Math.max(this._selectedIndex-1,0),this._scrollToSelected();else if(e.key==="Enter"){e.preventDefault();const t=this._filtered[this._selectedIndex];t&&this._execute(t)}else e.key==="Escape"&&this._close()}_scrollToSelected(){requestAnimationFrame(()=>{const e=this.renderRoot.querySelector(".item.selected");e&&e.scrollIntoView({block:"nearest"})})}_execute(e){this.dispatchEvent(new CustomEvent("execute",{detail:e,bubbles:!0,composed:!0}))}_close(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){return this.open?n`
    ...
    `:n``}}c(B,"properties",{open:{type:Boolean,reflect:!0},commands:{type:Array},_query:{state:!0},_filtered:{state:!0},_selectedIndex:{state:!0}}),c(B,"styles",b`
    :host {
      display: none;
    }
    :host([open]) {
  ...
  `);customElements.define("shenas-command-palette",B);const Z=b`
  table {
    width: 100%;
...
`;class N extends v{constructor(){super(),this.loading=!1,this.empty=!1,this.loadingText="Loading...",this.emptyText="No data",this.displayName=""}updated(e){e.has("displayName")&&this.displayName&&this.dispatchEvent(new CustomEvent("page-title",{bubbles:!0,composed:!0,detail:{title:this.displayName}}))}render(){return this.loading?n`<p class="loading">${this.loadingText}</p>`:this.empty?n`<p class="empty">${this.emptyText}</p>`:n`<slot></slot>`}}c(N,"properties",{loading:{type:Boolean,reflect:!0},empty:{type:Boolean,reflect:!0},loadingText:{type:String,attribute:"loading-text"},emptyText:{type:String,attribute:"empty-text"},displayName:{type:String,attribute:"display-name"}}),c(N,"styles",[E,b`
    ...
    `]);customElements.define("shenas-page",N);class R extends v{constructor(){super(),this.enabled=!1,this.toggleable=!1}updated(){this.title=this.enabled?"Enabled":"Disabled"}render(){return n`<div class="track" @click=${this._onClick}><div class="knob"></div></div>`}_onClick(){this.toggleable&&this.dispatchEvent(new CustomEvent("toggle",{bubbles:!0,composed:!0}))}}c(R,"properties",{enabled:{type:Boolean,reflect:!0},toggleable:{type:Boolean,reflect:!0}}),c(R,"styles",b`
    :host {
  ...
  `);customElements.define("status-toggle",R);class P extends v{constructor(){super(),this.columns=[],this.rows=[],this.rowClass=null,this.actions=null,this.emptyText="No items",this.showAdd=!1}_onAdd(){this.dispatchEvent(new CustomEvent("add",{bubbles:!0,composed:!0}))}render(){const e=typeof this.actions=="function",t=this.showAdd?n`<div class="add-row"><button class="add-btn" title="Add" @click=${this._onAdd}>+</button></div>`:"";return!this.rows||this.rows.length===0?n`<p class="empty">${this.emptyText}</p>${t}`:n`
      ...
      ${t}
    `}}c(P,"properties",{columns:{type:Array},rows:{type:Array},rowClass:{type:Object},actions:{type:Object},emptyText:{type:String,attribute:"empty-text"},showAdd:{type:Boolean,attribute:"show-add"}}),c(P,"styles",[Z,x,E,b`
      :host {
        display: block;
      }
      .mono {
    ...
    `]);customElements.define("shenas-data-list",P);class q extends v{constructor(){super(),this.title="",this.submitLabel="Save"}render(){return n`
    ...
    `}_onSubmit(){this.dispatchEvent(new CustomEvent("submit",{bubbles:!0,composed:!0}))}_onCancel(){this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}}c(q,"properties",{title:{type:String},submitLabel:{type:String,attribute:"submit-label"}}),c(q,"styles",[x,b`
      :host {
        display: block;
        margin: 1rem 0;
        padding: 1rem;
    ...
    `]);customElements.define("shenas-form-panel",q);async function m(l,e,t={}){const s=await fetch(`${l}/graphql`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({query:e,variables:t})});if(!s.ok)return null;const a=await s.json();return a.errors?(console.warn("GraphQL errors:",a.errors),null):a.data}async function g(l,e,t={}){const s=await fetch(`${l}/graphql`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({query:e,variables:t})});if(!s.ok)return{ok:!1,data:null,errors:[{message:`HTTP ${s.status}`}]};const a=await s.json();return{ok:!a.errors,data:a.data,errors:a.errors||[]}}function z(l){return l?n`<div class="message ${l.type}">${l.text}</div>`:""}function X(l,e,t){l.dispatchEvent(new CustomEvent("register-command",{bubbles:!0,composed:!0,detail:{componentId:e,commands:t}}))}let G=!1;class O extends v{constructor(){super(),this.apiBase="/api",this._loading=!0,this._empty=!1,this._cy=null,this._elements=null,this._resizeObserver=null}connectedCallback(){super.connectedCallback(),this._fetchData()}disconnectedCallback(){super.disconnectedCallback(),this._cy&&(this._cy.destroy(),this._cy=null),this._resizeObserver&&(this._resizeObserver.disconnect(),this._resizeObserver=null)}async _fetchData(){this._loading=!0;try{const e=await m(this.apiBase,`{
    ...
    `}}c(O,"properties",{apiBase:{type:String,attribute:"api-base"},_loading:{state:!0},_empty:{state:!0}}),c(O,"styles",[E,b`
      :host {
        display: block;
      }
      #cy {
    ...
    `}}c(A,"properties",{apiBase:{type:String,attribute:"api-base"},pipeName:{type:String,attribute:"pipe-name"},_fields:{state:!0},_instructions:{state:!0},_loading:{state:!0},_message:{state:!0},_needsMfa:{state:!0},_oauthUrl:{state:!0},_submitting:{state:!0},_stored:{state:!0}}),c(A,"styles",[x,D,C,b`
      :host {
        display: block;
      }
      .instructions {
    ...
    `}};c(y,"properties",{apiBase:{type:String,attribute:"api-base"},kind:{type:String},name:{type:String},_config:{state:!0},_loading:{state:!0},_message:{state:!0},_editing:{state:!0},_editValue:{state:!0},_freqNum:{state:!0},_freqUnit:{state:!0}}),c(y,"styles",[x,D,C,b`
      :host {
        display: block;
      }
      .config-row {
    ...
    `]),c(y,"_UNIT_MULTIPLIERS",{seconds:1/60,minutes:1,hours:60,days:1440}),c(y,"_DURATION_FIELDS",new Set(["sync_frequency","lookback_period"]));let F=y;customElements.define("shenas-config",F);function ae(l){if(!l)return null;const e=l.split("+").map(t=>t.trim().toLowerCase());return{ctrl:e.includes("ctrl")||e.includes("cmd"),shift:e.includes("shift"),alt:e.includes("alt"),key:e.filter(t=>!["ctrl","cmd","shift","alt"].includes(t))[0]||""}}function ie(l){const e=[];(l.ctrlKey||l.metaKey)&&e.push("Ctrl"),l.shiftKey&&e.push("Shift"),l.altKey&&e.push("Alt");const t=l.key.length===1?l.key.toUpperCase():l.key;return["Control","Shift","Alt","Meta"].includes(l.key)||e.push(t),e.join("+")}function ne(l,e){const t=ae(e);return!t||!t.key?!1:(l.ctrlKey||l.metaKey)===t.ctrl&&l.shiftKey===t.shift&&l.altKey===t.alt&&l.key.toLowerCase()===t.key}const k=[{id:"pipe",label:"Pipes"},{id:"schema",label:"Schemas"},{id:"component",label:"Components"},{id:"ui",label:"UI"},{id:"theme",label:"Themes"}];class L extends v{constructor(){super(),this.apiBase="/api",this.actions=[],this._bindings={},this._recording=null,this._recordedKey="",this._conflict=null,this._loading=!0,this._filter=""}connectedCallback(){super.connectedCallback(),this._loadBindings(),this._boundKeydown=e=>this._onKeydown(e),document.addEventListener("keydown",this._boundKeydown,!0)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this._boundKeydown,!0)}async _loadBindings(){this._loading=!0;const e=await m(this.apiBase,"{ hotkeys }");this._bindings=(e==null?void 0:e.hotkeys)||{},this._loading=!1}async _saveBinding(e,t){t?await g(this.apiBase,"mutation($id: String!, $b: String!) { setHotkey(actionId: $id, binding: $b) { ok } }",{id:e,b:t}):await g(this.apiBase,"mutation($id: String!) { deleteHotkey(actionId: $id) { ok } }",{id:e}),this.dispatchEvent(new CustomEvent("hotkeys-changed",{bubbles:!0,composed:!0}))}_startRecording(e){this._recording=e,this._recordedKey="",this._conflict=null}_stopRecording(){this._recording=null,this._recordedKey="",this._conflict=null}_onKeydown(e){if(!this._recording)return;if(e.preventDefault(),e.stopPropagation(),e.key==="Escape"){this._stopRecording();return}if(["Control","Shift","Alt","Meta"].includes(e.key))return;const t=ie(e);this._recordedKey=t;const s=Object.entries(this._bindings).find(([a,i])=>i===t&&a!==this._recording);this._conflict=s?s[0]:null}async _applyRecording(){!this._recordedKey||!this._recording||(this._conflict&&(this._bindings={...this._bindings,[this._conflict]:""},await this._saveBinding(this._conflict,"")),this._bindings={...this._bindings,[this._recording]:this._recordedKey},await this._saveBinding(this._recording,this._recordedKey),this._stopRecording())}async _clearBinding(e){this._bindings={...this._bindings,[e]:""},await this._saveBinding(e,"")}async _resetDefaults(){await g(this.apiBase,"mutation { resetHotkeys { ok } }"),await this._loadBindings(),this.dispatchEvent(new CustomEvent("hotkeys-changed",{bubbles:!0,composed:!0}))}_getActionLabel(e){const t=this.actions.find(s=>s.id===e);return t?t.label:e}_getActionCategory(e){const t=this.actions.find(s=>s.id===e);return t?t.category:""}render(){if(this._loading)return n`<p class="loading">Loading hotkeys...</p>`;const e=this._filter.toLowerCase(),t=this.actions.filter(s=>!e||s.label.toLowerCase().includes(e)||s.category.toLowerCase().includes(e));return n`
      <div class="toolbar">
    ...
    `}}c(L,"properties",{apiBase:{type:String,attribute:"api-base"},actions:{type:Array},_bindings:{state:!0},_recording:{state:!0},_recordedKey:{state:!0},_conflict:{state:!0},_loading:{state:!0},_filter:{state:!0}}),c(L,"styles",[x,C,E,b`
      :host {
        display: block;
      }
      .toolbar {
    ...
    `}_formatTime(e){if(!e)return"-";const t=new Date(String(e).endsWith("Z")?e:e+"Z");if(isNaN(t))return String(e).replace("T"," ").slice(0,23);const s=(a,i=2)=>String(a).padStart(i,"0");return`${t.getFullYear()}-${s(t.getMonth()+1)}-${s(t.getDate())} ${s(t.getHours())}:${s(t.getMinutes())}:${s(t.getSeconds())}.${s(t.getMilliseconds(),3)}`}}c(K,"properties",{apiBase:{type:String,attribute:"api-base"},pipe:{type:String},_activeTab:{state:!0},_logs:{state:!0},_spans:{state:!0},_loading:{state:!0},_search:{state:!0},_severity:{state:!0},_expanded:{state:!0},_live:{state:!0}}),c(K,"styles",[x,E,b`
      :host {
        display: flex;
        flex-direction: column;
        height: 100%;
    ...
    `]);customElements.define("shenas-logs",K);class M extends v{constructor(){super();c(this,"_router",new te(this,[{path:"/",render:()=>this._renderDynamicHome()},{path:"/settings",render:()=>this._renderSettings("data-flow")},{path:"/settings/:kind",render:({kind:t})=>this._renderSettings(t)},{path:"/settings/:kind/:name",render:({kind:t,name:s})=>this._renderPluginDetail(t,s)},{path:"/settings/:kind/:name/config",render:({kind:t,name:s})=>this._renderPluginDetail(t,s,"config")},{path:"/settings/:kind/:name/auth",render:({kind:t,name:s})=>this._renderPluginDetail(t,s,"auth")},{path:"/settings/:kind/:name/data",render:({kind:t,name:s})=>this._renderPluginDetail(t,s,"data")},{path:"/settings/:kind/:name/logs",render:({kind:t,name:s})=>this._renderPluginDetail(t,s,"logs")},{path:"/logs",render:()=>n`<shenas-logs api-base="${this.apiBase}"></shenas-logs>`},{path:"/:tab",render:({tab:t})=>this._renderDynamicTab(t)}]));c(this,"_hotkeys",{});c(this,"_pluginDisplayNames",{});c(this,"_nextTabId",1);c(this,"_saveWorkspaceTimer",null);this.apiBase="/api",this._components=[],this._loading=!0,this._loadedScripts=new Set,this._elementCache=new Map,this._leftWidth=160,this._rightWidth=220,this._dbStatus=null,this._inspectTable=null,this._inspectRows=null,this._paletteOpen=!1,this._paletteCommands=[],this._navPaletteOpen=!1,this._navCommands=[],this._registeredCommands=new Map,this._tabs=[],this._activeTabId=null}connectedCallback(){super.connectedCallback(),this._fetchData(),this.addEventListener("plugin-state-changed",()=>this._refreshComponents()),this.addEventListener("inspect-table",t=>this._inspect(t.detail.schema,t.detail.table)),this.addEventListener("page-title",t=>{this._activeTabId!=null&&(this._tabs=this._tabs.map(s=>s.id===this._activeTabId?{...s,label:t.detail.title}:s))}),this.addEventListener("navigate",t=>this._navigateTo(t.detail.path,t.detail.label)),this.addEventListener("register-command",t=>{const{componentId:s,commands:a}=t.detail;!a||a.length===0?this._registeredCommands.delete(s):this._registeredCommands.set(s,a)}),this._loadHotkeys(),this._keyHandler=t=>{for(const[s,a]of Object.entries(this._hotkeys))if(a&&ne(t,a))for(const i of this._registeredCommands.values()){const r=i.find(o=>o.id===s);if(r&&r.action){t.preventDefault(),r.action();return}}},document.addEventListener("keydown",this._keyHandler),this.addEventListener("hotkeys-changed",()=>this._loadHotkeys())}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this._keyHandler)}async _loadHotkeys(){const t=await m(this.apiBase,"{ hotkeys }");this._hotkeys=(t==null?void 0:t.hotkeys)||{}}_togglePalette(){if(this._paletteOpen){this._paletteOpen=!1;return}this._navPaletteOpen=!1,this._buildCommands(),this._paletteOpen=!0}async _toggleNavPalette(){if(this._navPaletteOpen){this._navPaletteOpen=!1;return}this._paletteOpen=!1,await this._buildNavCommands(),this._navPaletteOpen=!0}async _buildNavCommands(){const t=[];for(const a of this._components)t.push({id:`nav:${a.name}`,category:"Page",label:a.display_name||a.name,path:`/${a.name}`});t.push({id:"nav:dataflow",category:"Settings",label:"Data Flow",path:"/settings/data-flow"});for(const a of k)t.push({id:`nav:settings:${a.id}`,category:"Settings",label:a.label,path:`/settings/${a.id}`});let s=[];try{s=(await Promise.all(k.map(async i=>{const r=await m(this.apiBase,"query($kind: String!) { plugins(kind: $kind) { name displayName enabled } }",{kind:i.id});return((r==null?void 0:r.plugins)||[]).map(o=>({...o,display_name:o.displayName,kind:i.id,kindLabel:i.label}))}))).flat()}catch{}for(const a of s)t.push({id:`nav:${a.kind}:${a.name}`,category:a.kindLabel,label:a.display_name||a.name,path:`/settings/${a.kind}/${a.name}`});this._navCommands=t}async _registerGlobalCommands(){var a;const t=[],s={};try{for(const r of k){const o=await m(this.apiBase,"query($kind: String!) { plugins(kind: $kind) { name displayName enabled } }",{kind:r.id}),h=(o==null?void 0:o.plugins)||[];for(const f of h){const p=f.displayName||f.name;s[`${r.id}:${f.name}`]=p;const u=f.enabled!==!1;t.push({id:`toggle:${r.id}:${f.name}`,category:r.label,label:`Toggle ${p}`,action:async()=>{const d=u?"mutation($k: String!, $n: String!) { disablePlugin(kind: $k, name: $n) { ok } }":"mutation($k: String!, $n: String!) { enablePlugin(kind: $k, name: $n) { ok } }";await g(this.apiBase,d,{k:r.id,n:f.name}),await this._registerGlobalCommands()}}),r.id==="pipe"&&u&&t.push({id:`sync:${f.name}`,category:"Pipe",label:`Sync ${p}`,action:()=>fetch(`${this.apiBase}/sync/${f.name}`,{method:"POST"})})}}t.push({id:"sync:all",category:"Pipe",label:"Sync All Pipes",action:()=>fetch(`${this.apiBase}/sync`,{method:"POST"})}),t.push({id:"seed:transforms",category:"Transform",label:"Seed Default Transforms",action:()=>g(this.apiBase,"mutation { seedTransforms }")});for(const r of k){if(r.id!=="pipe")continue;const o=await m(this.apiBase,"query($kind: String!) { plugins(kind: $kind) { name displayName enabled } }",{kind:r.id});for(const h of(o==null?void 0:o.plugins)||[])h.enabled!==!1&&t.push({id:`transform:pipe:${h.name}`,category:"Transform",label:`Run Transforms: ${h.displayName||h.name}`,action:()=>g(this.apiBase,"mutation($pipe: String!) { runPipeTransforms(pipe: $pipe) }",{pipe:h.name})})}const i=await m(this.apiBase,'{ schemas: plugins(kind: "schema") { name displayName } schemaPlugins }');for(const r of(i==null?void 0:i.schemas)||[]){const o=((a=i==null?void 0:i.schemaPlugins)==null?void 0:a[r.name])||[];for(const h of o)t.push({id:`transform:schema:${h}`,category:"Transform",label:`Run Transforms -> ${r.displayName||r.name}: ${h}`,action:()=>g(this.apiBase,"mutation($schema: String!) { runSchemaTransforms(schema: $schema) }",{schema:h})})}}catch{}this._pluginDisplayNames=s,t.push({id:"command-palette",category:"System",label:"Command Palette",action:()=>this._togglePalette()},{id:"navigation-palette",category:"System",label:"Navigation Palette",action:()=>this._toggleNavPalette()},{id:"close-tab",category:"System",label:"Close Tab",action:()=>{this._activeTabId!=null&&this._closeTab(this._activeTabId)}},{id:"new-tab",category:"System",label:"New Tab",action:()=>this._addTab()}),this._registeredCommands.set("global",t)}_buildCommands(){const t=[];for(const s of this._registeredCommands.values())t.push(...s);this._paletteCommands=t}_executePaletteCommand(t){const s=t.detail;s.path?this._openTab(s.path,s.label):s.action&&s.action(),this._paletteOpen=!1,this._navPaletteOpen=!1}_navigateTo(t,s){if(this._tabs.length===0||!this._activeTabId){this._openTab(t,s);return}const a=s||this._labelForPath(t);this._tabs=this._tabs.map(i=>i.id===this._activeTabId?{...i,path:t,label:a}:i),window.history.pushState({},"",t),this._router.goto(t),this._saveWorkspace()}_openTab(t,s){const a=this._nextTabId++;this._tabs=[...this._tabs,{id:a,path:t,label:s||this._labelForPath(t)}],this._activeTabId=a,window.history.pushState({},"",t),this._router.goto(t),this._saveWorkspace()}async _addTab(){await this._buildNavCommands(),this._navPaletteOpen=!0}_closeTab(t){const s=this._tabs.findIndex(i=>i.id===t);if(s===-1)return;const a=this._tabs.filter(i=>i.id!==t);if(this._tabs=a,this._activeTabId===t)if(a.length>0){const i=a[Math.min(s,a.length-1)];this._activeTabId=i.id,this._router.goto(i.path)}else this._activeTabId=null,window.history.pushState({},"","/");this._saveWorkspace()}_switchTab(t){const s=this._tabs.find(a=>a.id===t);s&&(this._activeTabId=t,window.history.pushState({},"",s.path),this._router.goto(s.path),this._saveWorkspace())}_saveWorkspace(){clearTimeout(this._saveWorkspaceTimer),this._saveWorkspaceTimer=setTimeout(()=>{const t={tabs:this._tabs,activeTabId:this._activeTabId,nextTabId:this._nextTabId};g(this.apiBase,"mutation($data: JSON!) { saveWorkspace(data: $data) { ok } }",{data:t}).catch(()=>{})},300)}async _loadWorkspace(){try{const t=await m(this.apiBase,"{ workspace }"),s=t==null?void 0:t.workspace;if(!s)return;if(s.tabs&&s.tabs.length>0){this._tabs=s.tabs,this._activeTabId=s.activeTabId||s.tabs[0].id,this._nextTabId=s.nextTabId||Math.max(...s.tabs.map(r=>r.id))+1;const a=window.location.pathname;if(a&&a!=="/"&&!this._tabs.some(r=>r.path===a)){this._openTab(a);return}const i=this._tabs.find(r=>r.id===this._activeTabId);i&&this._router.goto(i.path)}else{const a=window.location.pathname;a&&a!=="/"&&this._openTab(a)}}catch{const t=window.location.pathname;t&&t!=="/"&&this._openTab(t)}}_labelForPath(t){const s=t.replace(/^\/+/,"");if(!s||s==="settings"||s==="settings/data-flow")return"Data Flow";const a=s.split("/");if(a[0]==="settings"){if(a.length===2){const r=k.find(o=>o.id===a[1]);return r?r.label:a[1]}if(a.length>=3){const r=`${a[1]}:${a[2]}`;return this._pluginDisplayNames[r]||a[2]}}const i=this._components.find(r=>r.name===a[0]);return i?i.display_name||i.name:a[0]}async _refreshComponents(){const t=await m(this.apiBase,"{ components }");this._components=(t==null?void 0:t.components)||[]}async _fetchData(){this._loading=!0;try{const t=await m(this.apiBase,"{ components dbStatus { keySource dbPath sizeMb schemas { name tables { name rows cols earliest latest } } } }");this._components=(t==null?void 0:t.components)||[],this._dbStatus=t==null?void 0:t.dbStatus}catch(t){console.error("Failed to fetch data:",t)}await this._registerGlobalCommands(),this._loading=!1,await this._loadWorkspace()}_activeTab(){return(window.location.pathname.replace(/^\/+/,"")||"").split("/")[0]||(this._components.length>0?this._components[0].name:"settings")}_startDrag(t){return s=>{s.preventDefault();const a=s.clientX,i=t==="left"?this._leftWidth:this._rightWidth,r=s.target;r.classList.add("dragging");const o=f=>{const p=t==="left"?f.clientX-a:a-f.clientX,u=Math.max(80,Math.min(400,i+p));t==="left"?this._leftWidth=u:this._rightWidth=u},h=()=>{r.classList.remove("dragging"),window.removeEventListener("mousemove",o),window.removeEventListener("mouseup",h)};window.addEventListener("mousemove",o),window.addEventListener("mouseup",h)}}render(){var s;if(this._loading)return n`<shenas-page loading></shenas-page>`;const t=this._activeTab();return n`
      <div class="layout">
    ...
    ></shenas-settings>`}async _inspect(t,s){if(!/^[a-zA-Z_]\w*$/.test(t)||!/^[a-zA-Z_]\w*$/.test(s))return;const a=`${t}.${s}`;if(this._inspectTable===a){this._inspectTable=null,this._inspectRows=null;return}this._inspectTable=a,this._inspectRows=null;try{const i=await m(this.apiBase,"query($s: String!, $t: String!) { tablePreview(schema: $s, table: $t, limit: 50) }",{s:t,t:s});this._inspectRows=(i==null?void 0:i.tablePreview)||[]}catch{this._inspectRows=[]}}_renderDbStats(){const t=this._dbStatus;return t?n`
    ...
    `}_getOrCreateElement(t){if(!this._elementCache.has(t.name)){const s=document.createElement(t.tag);s.setAttribute("api-base",this.apiBase),this._elementCache.set(t.name,s)}return this._elementCache.get(t.name)}}c(M,"properties",{apiBase:{type:String,attribute:"api-base"},_components:{state:!0},_loading:{state:!0},_loadedScripts:{state:!0},_leftWidth:{state:!0},_rightWidth:{state:!0},_dbStatus:{state:!0},_inspectTable:{state:!0},_inspectRows:{state:!0},_paletteOpen:{state:!0},_paletteCommands:{state:!0},_navPaletteOpen:{state:!0},_navCommands:{state:!0},_tabs:{state:!0},_activeTabId:{state:!0}}),c(M,"styles",[H,E,b`
      :host {
        display: block;
        height: 100vh;
        color: var(--shenas-text, #222);
    ...
    `]);customElements.define("shenas-app",M);class U extends v{constructor(){super(),this.apiBase="/api",this.activeKind="data-flow",this.onNavigate=null,this._plugins={},this._loading=!0,this._actionMessage=null,this._installing=!1,this._menuOpen=!1}connectedCallback(){super.connectedCallback(),this._fetchAll()}async _fetchAll(){this._loading=!0;const e={};await Promise.all(k.map(async({id:t})=>{const s=await m(this.apiBase,"query($kind: String!) { plugins(kind: $kind) { name displayName package version enabled description } }",{kind:t});e[t]=(s==null?void 0:s.plugins)||[]})),this._plugins=e,this._loading=!1}async _togglePlugin(e,t,s){const a=s?"disable":"enable",i=a==="enable"?"mutation($k: String!, $n: String!) { enablePlugin(kind: $k, name: $n) { ok message } }":"mutation($k: String!, $n: String!) { disablePlugin(kind: $k, name: $n) { ok message } }",{data:r}=await g(this.apiBase,i,{k:e,n:t}),o=a==="enable"?r==null?void 0:r.enablePlugin:r==null?void 0:r.disablePlugin;o!=null&&o.ok||(this._actionMessage={type:"error",text:(o==null?void 0:o.message)||`${a} failed`}),e==="theme"&&await this._applyActiveTheme(),await this._fetchAll()}async _applyActiveTheme(){const e=await m(this.apiBase,"{ theme { css } }");if(!(e!=null&&e.theme))return;const{css:t}=e.theme;let s=document.querySelector("link[data-shenas-theme]");t?(s||(s=document.createElement("link"),s.rel="stylesheet",s.setAttribute("data-shenas-theme",""),document.head.appendChild(s)),s.href=t):s&&s.remove()}async _install(e){var r,o,h;const t=this.shadowRoot.querySelector(`#install-${e}`),s=(r=t==null?void 0:t.value)==null?void 0:r.trim();if(!s)return;this._actionMessage=null;const{data:a}=await g(this.apiBase,"mutation($kind: String!, $names: [String!]!) { installPlugins(kind: $kind, names: $names, skipVerify: true) { results { name ok message } } }",{kind:e,names:[s]}),i=(h=(o=a==null?void 0:a.installPlugins)==null?void 0:o.results)==null?void 0:h[0];i!=null&&i.ok?(this._actionMessage={type:"success",text:i.message},this._installing=!1,await this._fetchAll()):this._actionMessage={type:"error",text:(i==null?void 0:i.message)||"Install failed"}}_switchKind(e){this.activeKind=e,this._menuOpen=!1,this.onNavigate&&this.onNavigate(e)}_displayName(){if(this.activeKind==="data-flow")return"Data Flow";if(this.activeKind==="hotkeys")return"Hotkeys";const e=k.find(t=>t.id===this.activeKind);return e?e.label:this.activeKind}render(){return n`
    ...
    `}_formatFreq(e){return e>=1440&&e%1440===0?`${e/1440}d`:e>=60&&e%60===0?`${e/60}h`:e>=1?`${e}m`:`${e*60}s`}_renderKind(e){var a;const t=this._plugins[e]||[],s=((a=k.find(i=>i.id===e))==null?void 0:a.label)||e;return n`
      <h3>${s}</h3>
      <shenas-data-list
    ...
    `}}c(U,"properties",{apiBase:{type:String,attribute:"api-base"},activeKind:{type:String,attribute:"active-kind"},onNavigate:{type:Function},allActions:{type:Array},_plugins:{state:!0},_loading:{state:!0},_actionMessage:{state:!0},_installing:{state:!0},_menuOpen:{state:!0}}),c(U,"styles",[x,D,H,C,b`
      :host {
        display: block;
        height: 100%;
      }
    ...
    `]);customElements.define("shenas-settings",U);class j extends v{constructor(){super(),this.apiBase="/api",this.kind="",this.name="",this.activeTab="details",this._info=null,this._loading=!0,this._message=null,this._tables=[],this._syncing=!1,this._schemaTransforms=[],this._selectedTable=null,this._previewRows=null,this._previewLoading=!1}willUpdate(e){(e.has("kind")||e.has("name"))&&this._fetchInfo()}async _fetchInfo(){var f;if(!this.kind||!this.name)return;this._loading=!0,this._message=null;const e=await m(this.apiBase,"query($kind: String!, $name: String!) { pluginInfo(kind: $kind, name: $name) }",{kind:this.kind,name:this.name});this._info=e==null?void 0:e.pluginInfo;const t=this.kind==="pipe"||this.kind==="schema",s=this.kind==="schema",a=t||s?await m(this.apiBase,`{ ${t?"dbStatus { schemas { name tables { name rows cols earliest latest } } }":""} ${s?"schemaPlugins":""} ${s?"transforms { id sourceDuckdbTable targetDuckdbTable sourcePlugin enabled }":""} }`):null,i=a==null?void 0:a.dbStatus,r=a==null?void 0:a.schemaPlugins,o=(f=a==null?void 0:a.transforms)==null?void 0:f.map(p=>({...p,source_duckdb_table:p.sourceDuckdbTable,target_duckdb_table:p.targetDuckdbTable,source_plugin:p.sourcePlugin})),h=r?r[this.name]||[]:[];if(i){if(this.kind==="pipe"){const p=(i.schemas||[]).find(u=>u.name===this.name);this._tables=p?p.tables.filter(u=>!u.name.startsWith("_dlt_")):[]}else if(this.kind==="schema"){const p=(i.schemas||[]).find(u=>u.name==="metrics");this._tables=p?p.tables.filter(u=>h.includes(u.name)):[]}}o&&(this._schemaTransforms=o.filter(p=>h.includes(p.target_duckdb_table))),this._loading=!1,this._registerCommands()}_registerCommands(){if(!this._info)return;const e=this._info.display_name||this.name,t=[{id:`remove:${this.kind}:${this.name}`,category:"Plugin",label:`Remove ${e}`,action:()=>this._remove()}];this.kind==="schema"&&t.unshift({id:`flush:${this.kind}:${this.name}`,category:"Plugin",label:`Flush ${e}`,action:()=>this._flush()},{id:`transform:${this.kind}:${this.name}`,category:"Plugin",label:`Transform ${e}`,action:()=>this._runTransforms()}),X(this,`plugin-detail:${this.kind}:${this.name}`,t)}async _toggle(){var i;const e=((i=this._info)==null?void 0:i.enabled)!==!1?"disable":"enable",t=e==="enable"?"mutation($k: String!, $n: String!) { enablePlugin(kind: $k, name: $n) { ok message } }":"mutation($k: String!, $n: String!) { disablePlugin(kind: $k, name: $n) { ok message } }",{data:s}=await g(this.apiBase,t,{k:this.kind,n:this.name}),a=e==="enable"?s==null?void 0:s.enablePlugin:s==null?void 0:s.disablePlugin;this._message={type:a!=null&&a.ok?"success":"error",text:(a==null?void 0:a.message)||`${e} failed`},await this._fetchInfo(),this.dispatchEvent(new CustomEvent("plugin-state-changed",{bubbles:!0,composed:!0}))}async _sync(){this._syncing=!0,this._message=null;try{const e=await fetch(`${this.apiBase}/sync/${this.name}`,{method:"POST"});if(!e.ok){const h=await e.json().catch(()=>({}));this._message={type:"error",text:h.detail||`Sync failed (${e.status})`},this._syncing=!1;return}const t=e.body.getReader(),s=new TextDecoder;let a="",i="",r=!1;for(;;){const{done:h,value:f}=await t.read();if(h)break;const p=s.decode(f,{stream:!0});for(const u of p.split(`
`))u.startsWith("event: ")&&(a=u.slice(7).trim()),u.startsWith("data: ")&&(i=u.slice(6));a==="error"&&(r=!0)}let o="Sync complete";try{o=JSON.parse(i).message||o}catch{}this._message={type:r?"error":"success",text:o},r||await this._fetchInfo()}catch(e){this._message={type:"error",text:`Sync failed: ${e.message}`}}this._syncing=!1}async _runTransforms(){this._transforming=!0,this._message=null;try{const{data:e}=await g(this.apiBase,"mutation($s: String!) { runSchemaTransforms(schema: $s) }",{s:this.name}),t=e==null?void 0:e.runSchemaTransforms;(t==null?void 0:t.count)!=null?(this._message={type:"success",text:`Ran ${t.count} transform(s)`},await this._fetchInfo()):this._message={type:"error",text:"Transform failed"}}catch(e){this._message={type:"error",text:`Transform failed: ${e.message}`}}this._transforming=!1}async _flush(){this._message=null;try{const{data:e}=await g(this.apiBase,"mutation($s: String!) { flushSchema(schemaPlugin: $s) }",{s:this.name}),t=e==null?void 0:e.flushSchema;(t==null?void 0:t.rows_deleted)!=null?(this._message={type:"success",text:`Flushed ${t.rows_deleted} rows`},await this._fetchInfo()):this._message={type:"error",text:"Flush failed"}}catch(e){this._message={type:"error",text:`Flush failed: ${e.message}`}}}async _remove(){var t,s;const{data:e}=await g(this.apiBase,"mutation($k: String!, $n: String!) { removePlugin(kind: $k, name: $n) { ok message } }",{k:this.kind,n:this.name});(t=e==null?void 0:e.removePlugin)!=null&&t.ok?(window.history.pushState({},"",`/settings/${this.kind}`),window.dispatchEvent(new PopStateEvent("popstate"))):this._message={type:"error",text:((s=e==null?void 0:e.removePlugin)==null?void 0:s.message)||"Remove failed"}}_switchTab(e){this.activeTab=e;const t=`/settings/${this.kind}/${this.name}`,s=e==="details"?t:`${t}/${e}`;window.history.pushState({},"",s)}async _fetchPreview(e){if(this._selectedTable=e,!e){this._previewRows=null;return}this._previewLoading=!0;const t=this.kind==="schema"?"metrics":this.name,s=await m(this.apiBase,"query($s: String!, $t: String!) { tablePreview(schema: $s, table: $t, limit: 100) }",{s:t,t:e});this._previewRows=s==null?void 0:s.tablePreview,this._previewLoading=!1}_renderData(){var t,s;const e=this._tables||[];if(e.length===0)return n`<p style="color:var(--shenas-text-muted,#888)">No tables synced yet.</p>`;if(!this._selectedTable){const a=(t=this._info)==null?void 0:t.primary_table,i=a&&e.some(r=>r.name===a)?a:(s=e[0])==null?void 0:s.name;i&&this._fetchPreview(i)}return n`
    ...
    `:""}}c(j,"properties",{apiBase:{type:String,attribute:"api-base"},kind:{type:String},name:{type:String},activeTab:{type:String,attribute:"active-tab"},_info:{state:!0},_loading:{state:!0},_message:{state:!0},_tables:{state:!0},_syncing:{state:!0},_transforming:{state:!0},_schemaTransforms:{state:!0},_selectedTable:{state:!0},_previewRows:{state:!0},_previewLoading:{state:!0}}),c(j,"styles",[x,H,C,se,b`
      :host {
        display: block;
      }
      .back {
    ...
    `}}c(W,"properties",{apiBase:{type:String,attribute:"api-base"},source:{type:String},_transforms:{state:!0},_loading:{state:!0},_editing:{state:!0},_editSql:{state:!0},_message:{state:!0},_previewRows:{state:!0},_creating:{state:!0},_newForm:{state:!0},_dbTables:{state:!0},_schemaTables:{state:!0}}),c(W,"styles",[Z,x,D,C,b`
      :host {
        display: block;
      }
      .edit-panel {
