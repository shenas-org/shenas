var Q=Object.defineProperty;var Y=(o,e,t)=>e in o?Q(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var c=(o,e,t)=>Y(o,typeof e!="symbol"?e+"":e,t);import{LitElement as v,css as u,html as n}from"lit";import V,{dagre as ee}from"cytoscape";import{Router as te}from"@lit-labs/router";class N extends v{constructor(){super(),this.open=!1,this.commands=[],this._query="",this._filtered=[],this._selectedIndex=0}updated(e){e.has("open")&&this.open&&(this._query="",this._selectedIndex=0,this._filter(),requestAnimationFrame(()=>{const t=this.renderRoot.querySelector("input");t&&t.focus()})),e.has("commands")&&this._filter()}_filter(){const e=this._query.toLowerCase();e?this._filtered=this.commands.filter(t=>t.label.toLowerCase().includes(e)||t.category.toLowerCase().includes(e)||(t.description||"").toLowerCase().includes(e)):this._filtered=this.commands,this._selectedIndex>=this._filtered.length&&(this._selectedIndex=Math.max(0,this._filtered.length-1))}_onInput(e){this._query=e.target.value,this._selectedIndex=0,this._filter()}_onKeydown(e){if(e.key==="ArrowDown")e.preventDefault(),this._filtered.length>0&&(this._selectedIndex=Math.min(this._selectedIndex+1,this._filtered.length-1)),this._scrollToSelected();else if(e.key==="ArrowUp")e.preventDefault(),this._selectedIndex=Math.max(this._selectedIndex-1,0),this._scrollToSelected();else if(e.key==="Enter"){e.preventDefault();const t=this._filtered[this._selectedIndex];t&&this._execute(t)}else e.key==="Escape"&&this._close()}_scrollToSelected(){requestAnimationFrame(()=>{const e=this.renderRoot.querySelector(".item.selected");e&&e.scrollIntoView({block:"nearest"})})}_execute(e){this.dispatchEvent(new CustomEvent("execute",{detail:e,bubbles:!0,composed:!0}))}_close(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){return this.open?n`
    ...
    `:n``}}c(N,"properties",{open:{type:Boolean,reflect:!0},commands:{type:Array},_query:{state:!0},_filtered:{state:!0},_selectedIndex:{state:!0}}),c(N,"styles",u`
    :host {
      display: none;
    }
    :host([open]) {
  ...
  `);customElements.define("shenas-command-palette",N);const Z=u`
  table {
    width: 100%;
...
`;class B extends v{constructor(){super(),this.loading=!1,this.empty=!1,this.loadingText="Loading...",this.emptyText="No data",this.displayName=""}updated(e){e.has("displayName")&&this.displayName&&this.dispatchEvent(new CustomEvent("page-title",{bubbles:!0,composed:!0,detail:{title:this.displayName}}))}render(){return this.loading?n`<p class="loading">${this.loadingText}</p>`:this.empty?n`<p class="empty">${this.emptyText}</p>`:n`<slot></slot>`}}c(B,"properties",{loading:{type:Boolean,reflect:!0},empty:{type:Boolean,reflect:!0},loadingText:{type:String,attribute:"loading-text"},emptyText:{type:String,attribute:"empty-text"},displayName:{type:String,attribute:"display-name"}}),c(B,"styles",[E,u`
    ...
    `]);customElements.define("shenas-page",B);class R extends v{constructor(){super(),this.enabled=!1,this.toggleable=!1}updated(){this.title=this.enabled?"Enabled":"Disabled"}render(){return n`<div class="track" @click=${this._onClick}><div class="knob"></div></div>`}_onClick(){this.toggleable&&this.dispatchEvent(new CustomEvent("toggle",{bubbles:!0,composed:!0}))}}c(R,"properties",{enabled:{type:Boolean,reflect:!0},toggleable:{type:Boolean,reflect:!0}}),c(R,"styles",u`
    :host {
  ...
  `);customElements.define("status-toggle",R);class P extends v{constructor(){super(),this.columns=[],this.rows=[],this.rowClass=null,this.actions=null,this.emptyText="No items",this.showAdd=!1}_onAdd(){this.dispatchEvent(new CustomEvent("add",{bubbles:!0,composed:!0}))}render(){const e=typeof this.actions=="function",t=this.showAdd?n`<div class="add-row"><button class="add-btn" title="Add" @click=${this._onAdd}>+</button></div>`:"";return!this.rows||this.rows.length===0?n`<p class="empty">${this.emptyText}</p>${t}`:n`
      ...
      ${t}
    `}}c(P,"properties",{columns:{type:Array},rows:{type:Array},rowClass:{type:Object},actions:{type:Object},emptyText:{type:String,attribute:"empty-text"},showAdd:{type:Boolean,attribute:"show-add"}}),c(P,"styles",[Z,x,E,u`
      :host {
        display: block;
      }
      .mono {
    ...
    `}_onSubmit(){this.dispatchEvent(new CustomEvent("submit",{bubbles:!0,composed:!0}))}_onCancel(){this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}}c(q,"properties",{title:{type:String},submitLabel:{type:String,attribute:"submit-label"}}),c(q,"styles",[x,u`
      :host {
        display: block;
        margin: 1rem 0;
        padding: 1rem;
    ...
    `]);customElements.define("shenas-form-panel",q);async function b(o,e,t={}){const s=await fetch(`${o}/graphql`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({query:e,variables:t})});if(!s.ok)return null;const a=await s.json();return a.errors?(console.warn("GraphQL errors:",a.errors),null):a.data}async function m(o,e,t={}){const s=await fetch(`${o}/graphql`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({query:e,variables:t})});if(!s.ok)return{ok:!1,data:null,errors:[{message:`HTTP ${s.status}`}]};const a=await s.json();return{ok:!a.errors,data:a.data,errors:a.errors||[]}}function D(o){return o?n`<div class="message ${o.type}">${o.text}</div>`:""}function X(o,e,t){o.dispatchEvent(new CustomEvent("register-command",{bubbles:!0,composed:!0,detail:{componentId:e,commands:t}}))}let G=!1;class O extends v{constructor(){super(),this.apiBase="/api",this._loading=!0,this._empty=!1,this._cy=null,this._elements=null,this._resizeObserver=null}connectedCallback(){super.connectedCallback(),this._fetchData()}disconnectedCallback(){super.disconnectedCallback(),this._cy&&(this._cy.destroy(),this._cy=null),this._resizeObserver&&(this._resizeObserver.disconnect(),this._resizeObserver=null)}async _fetchData(){this._loading=!0;try{const e=await b(this.apiBase,`{
    ...
    `}}c(O,"properties",{apiBase:{type:String,attribute:"api-base"},_loading:{state:!0},_empty:{state:!0}}),c(O,"styles",[E,u`
      :host {
        display: block;
      }
      #cy {
    ...
    `}}c(A,"properties",{apiBase:{type:String,attribute:"api-base"},pipeName:{type:String,attribute:"pipe-name"},_fields:{state:!0},_instructions:{state:!0},_loading:{state:!0},_message:{state:!0},_needsMfa:{state:!0},_oauthUrl:{state:!0},_submitting:{state:!0},_stored:{state:!0}}),c(A,"styles",[x,I,C,u`
      :host {
        display: block;
      }
      .instructions {
    ...
    `}};c(y,"properties",{apiBase:{type:String,attribute:"api-base"},kind:{type:String},name:{type:String},_config:{state:!0},_loading:{state:!0},_message:{state:!0},_editing:{state:!0},_editValue:{state:!0},_freqNum:{state:!0},_freqUnit:{state:!0}}),c(y,"styles",[x,I,C,u`
      :host {
        display: block;
      }
      .config-row {
    ...
    `}}c(L,"properties",{apiBase:{type:String,attribute:"api-base"},actions:{type:Array},_bindings:{state:!0},_recording:{state:!0},_recordedKey:{state:!0},_conflict:{state:!0},_loading:{state:!0},_filter:{state:!0}}),c(L,"styles",[x,C,E,u`
      :host {
        display: block;
      }
      .toolbar {
    ...
    `]);customElements.define("shenas-logs",K);class M extends v{constructor(){super();c(this,"_router",new te(this,[{path:"/",render:()=>this._renderDynamicHome()},{path:"/settings",render:()=>this._renderSettings("data-flow")},{path:"/settings/:kind",render:({kind:t})=>this._renderSettings(t)},{path:"/settings/:kind/:name",render:({kind:t,name:s})=>this._renderPluginDetail(t,s)},{path:"/settings/:kind/:name/config",render:({kind:t,name:s})=>this._renderPluginDetail(t,s,"config")},{path:"/settings/:kind/:name/auth",render:({kind:t,name:s})=>this._renderPluginDetail(t,s,"auth")},{path:"/settings/:kind/:name/data",render:({kind:t,name:s})=>this._renderPluginDetail(t,s,"data")},{path:"/settings/:kind/:name/logs",render:({kind:t,name:s})=>this._renderPluginDetail(t,s,"logs")},{path:"/logs",render:()=>n`<shenas-logs api-base="${this.apiBase}"></shenas-logs>`},{path:"/:tab",render:({tab:t})=>this._renderDynamicTab(t)}]));c(this,"_hotkeys",{});c(this,"_pluginDisplayNames",{});c(this,"_nextTabId",1);c(this,"_saveWorkspaceTimer",null);c(this,"_allPlugins",{});this.apiBase="/api",this._components=[],this._loading=!0,this._loadedScripts=new Set,this._elementCache=new Map,this._leftWidth=160,this._rightWidth=220,this._dbStatus=null,this._inspectTable=null,this._inspectRows=null,this._paletteOpen=!1,this._paletteCommands=[],this._navPaletteOpen=!1,this._navCommands=[],this._registeredCommands=new Map,this._tabs=[],this._activeTabId=null}connectedCallback(){super.connectedCallback(),this._fetchData(),this.addEventListener("plugin-state-changed",()=>this._refreshComponents()),this.addEventListener("inspect-table",t=>this._inspect(t.detail.schema,t.detail.table)),this.addEventListener("page-title",t=>{this._activeTabId!=null&&(this._tabs=this._tabs.map(s=>s.id===this._activeTabId?{...s,label:t.detail.title}:s))}),this.addEventListener("navigate",t=>this._navigateTo(t.detail.path,t.detail.label)),this.addEventListener("register-command",t=>{const{componentId:s,commands:a}=t.detail;!a||a.length===0?this._registeredCommands.delete(s):this._registeredCommands.set(s,a)}),this._keyHandler=t=>{for(const[s,a]of Object.entries(this._hotkeys))if(a&&ne(t,a))for(const i of this._registeredCommands.values()){const r=i.find(l=>l.id===s);if(r&&r.action){t.preventDefault(),r.action();return}}},document.addEventListener("keydown",this._keyHandler),this.addEventListener("hotkeys-changed",()=>this._loadHotkeys())}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this._keyHandler)}async _loadHotkeys(){const t=await b(this.apiBase,"{ hotkeys }");this._hotkeys=(t==null?void 0:t.hotkeys)||{}}_togglePalette(){if(this._paletteOpen){this._paletteOpen=!1;return}this._navPaletteOpen=!1,this._buildCommands(),this._paletteOpen=!0}async _toggleNavPalette(){if(this._navPaletteOpen){this._navPaletteOpen=!1;return}this._paletteOpen=!1,await this._buildNavCommands(),this._navPaletteOpen=!0}async _buildNavCommands(){const t=[];for(const a of this._components)t.push({id:`nav:${a.name}`,category:"Page",label:a.display_name||a.name,path:`/${a.name}`});t.push({id:"nav:dataflow",category:"Settings",label:"Data Flow",path:"/settings/data-flow"});for(const a of k)t.push({id:`nav:settings:${a.id}`,category:"Settings",label:a.label,path:`/settings/${a.id}`});const s=k.flatMap(a=>(this._allPlugins[a.id]||[]).map(i=>({...i,display_name:i.displayName,kind:a.id,kindLabel:a.label})));for(const a of s)t.push({id:`nav:${a.kind}:${a.name}`,category:a.kindLabel,label:a.display_name||a.name,path:`/settings/${a.kind}/${a.name}`});this._navCommands=t}async _registerGlobalCommands(){const t=[],s={};try{const a=await b(this.apiBase,"{ schemaPlugins }"),i=(a==null?void 0:a.schemaPlugins)||{};for(const r of k){const l=this._allPlugins[r.id]||[];for(const d of l){const f=d.displayName||d.name;s[`${r.id}:${d.name}`]=f;const p=d.enabled!==!1;t.push({id:`toggle:${r.id}:${d.name}`,category:r.label,label:`Toggle ${f}`,action:async()=>{const g=p?"mutation($k: String!, $n: String!) { disablePlugin(kind: $k, name: $n) { ok } }":"mutation($k: String!, $n: String!) { enablePlugin(kind: $k, name: $n) { ok } }";await m(this.apiBase,g,{k:r.id,n:d.name}),await this._fetchData()}}),r.id==="pipe"&&p&&(t.push({id:`sync:${d.name}`,category:"Pipe",label:`Sync ${f}`,action:()=>fetch(`${this.apiBase}/sync/${d.name}`,{method:"POST"})}),t.push({id:`transform:pipe:${d.name}`,category:"Transform",label:`Run Transforms: ${f}`,action:()=>m(this.apiBase,"mutation($pipe: String!) { runPipeTransforms(pipe: $pipe) }",{pipe:d.name})}))}}t.push({id:"sync:all",category:"Pipe",label:"Sync All Pipes",action:()=>fetch(`${this.apiBase}/sync`,{method:"POST"})}),t.push({id:"seed:transforms",category:"Transform",label:"Seed Default Transforms",action:()=>m(this.apiBase,"mutation { seedTransforms }")});for(const r of this._allPlugins.schema||[]){const l=i[r.name]||[];for(const d of l)t.push({id:`transform:schema:${d}`,category:"Transform",label:`Run Transforms -> ${r.displayName||r.name}: ${d}`,action:()=>m(this.apiBase,"mutation($schema: String!) { runSchemaTransforms(schema: $schema) }",{schema:d})})}}catch{}this._pluginDisplayNames=s,t.push({id:"command-palette",category:"System",label:"Command Palette",action:()=>this._togglePalette()},{id:"navigation-palette",category:"System",label:"Navigation Palette",action:()=>this._toggleNavPalette()},{id:"close-tab",category:"System",label:"Close Tab",action:()=>{this._activeTabId!=null&&this._closeTab(this._activeTabId)}},{id:"new-tab",category:"System",label:"New Tab",action:()=>this._addTab()}),this._registeredCommands.set("global",t)}_buildCommands(){const t=[];for(const s of this._registeredCommands.values())t.push(...s);this._paletteCommands=t}_executePaletteCommand(t){const s=t.detail;s.path?this._openTab(s.path,s.label):s.action&&s.action(),this._paletteOpen=!1,this._navPaletteOpen=!1}_navigateTo(t,s){if(this._tabs.length===0||!this._activeTabId){this._openTab(t,s);return}const a=s||this._labelForPath(t);this._tabs=this._tabs.map(i=>i.id===this._activeTabId?{...i,path:t,label:a}:i),window.history.pushState({},"",t),this._router.goto(t),this._saveWorkspace()}_openTab(t,s){const a=this._nextTabId++;this._tabs=[...this._tabs,{id:a,path:t,label:s||this._labelForPath(t)}],this._activeTabId=a,window.history.pushState({},"",t),this._router.goto(t),this._saveWorkspace()}async _addTab(){await this._buildNavCommands(),this._navPaletteOpen=!0}_closeTab(t){const s=this._tabs.findIndex(i=>i.id===t);if(s===-1)return;const a=this._tabs.filter(i=>i.id!==t);if(this._tabs=a,this._activeTabId===t)if(a.length>0){const i=a[Math.min(s,a.length-1)];this._activeTabId=i.id,this._router.goto(i.path)}else this._activeTabId=null,window.history.pushState({},"","/");this._saveWorkspace()}_switchTab(t){const s=this._tabs.find(a=>a.id===t);s&&(this._activeTabId=t,window.history.pushState({},"",s.path),this._router.goto(s.path),this._saveWorkspace())}_saveWorkspace(){clearTimeout(this._saveWorkspaceTimer),this._saveWorkspaceTimer=setTimeout(()=>{const t={tabs:this._tabs,activeTabId:this._activeTabId,nextTabId:this._nextTabId};m(this.apiBase,"mutation($data: JSON!) { saveWorkspace(data: $data) { ok } }",{data:t}).catch(()=>{})},300)}async _loadWorkspace(){try{const t=await b(this.apiBase,"{ workspace }"),s=t==null?void 0:t.workspace;if(!s)return;if(s.tabs&&s.tabs.length>0){this._tabs=s.tabs,this._activeTabId=s.activeTabId||s.tabs[0].id,this._nextTabId=s.nextTabId||Math.max(...s.tabs.map(r=>r.id))+1;const a=window.location.pathname;if(a&&a!=="/"&&!this._tabs.some(r=>r.path===a)){this._openTab(a);return}const i=this._tabs.find(r=>r.id===this._activeTabId);i&&this._router.goto(i.path)}else{const a=window.location.pathname;a&&a!=="/"&&this._openTab(a)}}catch{const t=window.location.pathname;t&&t!=="/"&&this._openTab(t)}}_labelForPath(t){const s=t.replace(/^\/+/,"");if(!s||s==="settings"||s==="settings/data-flow")return"Data Flow";const a=s.split("/");if(a[0]==="settings"){if(a.length===2){const r=k.find(l=>l.id===a[1]);return r?r.label:a[1]}if(a.length>=3){const r=`${a[1]}:${a[2]}`;return this._pluginDisplayNames[r]||a[2]}}const i=this._components.find(r=>r.name===a[0]);return i?i.display_name||i.name:a[0]}async _refreshComponents(){const t=await b(this.apiBase,"{ components }");this._components=(t==null?void 0:t.components)||[]}async _fetchData(){var t;this._loading=!0;try{const s=await b(this.apiBase,`{
        ...
        schemaPlugins
      }`);this._components=(s==null?void 0:s.components)||[],this._dbStatus=s==null?void 0:s.dbStatus,this._hotkeys=(s==null?void 0:s.hotkeys)||{},this._allPlugins={pipe:(s==null?void 0:s.pipes)||[],schema:(s==null?void 0:s.schemas)||[],component:(s==null?void 0:s.componentPlugins)||[],ui:(s==null?void 0:s.uis)||[],theme:(s==null?void 0:s.themes)||[]};const a=s==null?void 0:s.workspace;if(((t=a==null?void 0:a.tabs)==null?void 0:t.length)>0){this._tabs=a.tabs,this._activeTabId=a.activeTabId||a.tabs[0].id,this._nextTabId=a.nextTabId||Math.max(...a.tabs.map(r=>r.id))+1;const i=window.location.pathname;if(i&&i!=="/"&&!this._tabs.some(r=>r.path===i))this._openTab(i);else{const r=this._tabs.find(l=>l.id===this._activeTabId);r&&this._router.goto(r.path)}}else{const i=window.location.pathname;i&&i!=="/"&&this._openTab(i)}}catch(s){console.error("Failed to fetch data:",s)}await this._registerGlobalCommands(),this._loading=!1}_activeTab(){return(window.location.pathname.replace(/^\/+/,"")||"").split("/")[0]||(this._components.length>0?this._components[0].name:"settings")}_startDrag(t){return s=>{s.preventDefault();const a=s.clientX,i=t==="left"?this._leftWidth:this._rightWidth,r=s.target;r.classList.add("dragging");const l=f=>{const p=t==="left"?f.clientX-a:a-f.clientX,g=Math.max(80,Math.min(400,i+p));t==="left"?this._leftWidth=g:this._rightWidth=g},d=()=>{r.classList.remove("dragging"),window.removeEventListener("mousemove",l),window.removeEventListener("mouseup",d)};window.addEventListener("mousemove",l),window.addEventListener("mouseup",d)}}render(){var s;if(this._loading)return n`<shenas-page loading></shenas-page>`;const t=this._activeTab();return n`
      <div class="layout">
    ...
    ></shenas-settings>`}async _inspect(t,s){if(!/^[a-zA-Z_]\w*$/.test(t)||!/^[a-zA-Z_]\w*$/.test(s))return;const a=`${t}.${s}`;if(this._inspectTable===a){this._inspectTable=null,this._inspectRows=null;return}this._inspectTable=a,this._inspectRows=null;try{const i=await b(this.apiBase,"query($s: String!, $t: String!) { tablePreview(schema: $s, table: $t, limit: 50) }",{s:t,t:s});this._inspectRows=(i==null?void 0:i.tablePreview)||[]}catch{this._inspectRows=[]}}_renderDbStats(){const t=this._dbStatus;return t?n`
    ...
    `]);customElements.define("shenas-app",M);class U extends v{constructor(){super(),this.apiBase="/api",this.activeKind="data-flow",this.onNavigate=null,this._plugins={},this._loading=!0,this._actionMessage=null,this._installing=!1,this._menuOpen=!1}connectedCallback(){super.connectedCallback(),this._fetchAll()}async _fetchAll(){this._loading=!0;const e={};await Promise.all(k.map(async({id:t})=>{const s=await b(this.apiBase,"query($kind: String!) { plugins(kind: $kind) { name displayName package version enabled description } }",{kind:t});e[t]=(s==null?void 0:s.plugins)||[]})),this._plugins=e,this._loading=!1}async _togglePlugin(e,t,s){const a=s?"disable":"enable",i=a==="enable"?"mutation($k: String!, $n: String!) { enablePlugin(kind: $k, name: $n) { ok message } }":"mutation($k: String!, $n: String!) { disablePlugin(kind: $k, name: $n) { ok message } }",{data:r}=await m(this.apiBase,i,{k:e,n:t}),l=a==="enable"?r==null?void 0:r.enablePlugin:r==null?void 0:r.disablePlugin;l!=null&&l.ok||(this._actionMessage={type:"error",text:(l==null?void 0:l.message)||`${a} failed`}),e==="theme"&&await this._applyActiveTheme(),await this._fetchAll()}async _applyActiveTheme(){const e=await b(this.apiBase,"{ theme { css } }");if(!(e!=null&&e.theme))return;const{css:t}=e.theme;let s=document.querySelector("link[data-shenas-theme]");t?(s||(s=document.createElement("link"),s.rel="stylesheet",s.setAttribute("data-shenas-theme",""),document.head.appendChild(s)),s.href=t):s&&s.remove()}async _install(e){var r,l,d;const t=this.shadowRoot.querySelector(`#install-${e}`),s=(r=t==null?void 0:t.value)==null?void 0:r.trim();if(!s)return;this._actionMessage=null;const{data:a}=await m(this.apiBase,"mutation($kind: String!, $names: [String!]!) { installPlugins(kind: $kind, names: $names, skipVerify: true) { results { name ok message } } }",{kind:e,names:[s]}),i=(d=(l=a==null?void 0:a.installPlugins)==null?void 0:l.results)==null?void 0:d[0];i!=null&&i.ok?(this._actionMessage={type:"success",text:i.message},this._installing=!1,await this._fetchAll()):this._actionMessage={type:"error",text:(i==null?void 0:i.message)||"Install failed"}}_switchKind(e){this.activeKind=e,this._menuOpen=!1,this.onNavigate&&this.onNavigate(e)}_displayName(){if(this.activeKind==="data-flow")return"Data Flow";if(this.activeKind==="hotkeys")return"Hotkeys";const e=k.find(t=>t.id===this.activeKind);return e?e.label:this.activeKind}render(){return n`
    ...
    `}}c(U,"properties",{apiBase:{type:String,attribute:"api-base"},activeKind:{type:String,attribute:"active-kind"},onNavigate:{type:Function},allActions:{type:Array},_plugins:{state:!0},_loading:{state:!0},_actionMessage:{state:!0},_installing:{state:!0},_menuOpen:{state:!0}}),c(U,"styles",[x,I,H,C,u`
      :host {
        display: block;
        height: 100%;
      }
...
`))g.startsWith("event: ")&&(a=g.slice(7).trim()),g.startsWith("data: ")&&(i=g.slice(6));a==="error"&&(r=!0)}let l="Sync complete";try{l=JSON.parse(i).message||l}catch{}this._message={type:r?"error":"success",text:l},r||await this._fetchInfo()}catch(e){this._message={type:"error",text:`Sync failed: ${e.message}`}}this._syncing=!1}async _runTransforms(){this._transforming=!0,this._message=null;try{const{data:e}=await m(this.apiBase,"mutation($s: String!) { runSchemaTransforms(schema: $s) }",{s:this.name}),t=e==null?void 0:e.runSchemaTransforms;(t==null?void 0:t.count)!=null?(this._message={type:"success",text:`Ran ${t.count} transform(s)`},await this._fetchInfo()):this._message={type:"error",text:"Transform failed"}}catch(e){this._message={type:"error",text:`Transform failed: ${e.message}`}}this._transforming=!1}async _flush(){this._message=null;try{const{data:e}=await m(this.apiBase,"mutation($s: String!) { flushSchema(schemaPlugin: $s) }",{s:this.name}),t=e==null?void 0:e.flushSchema;(t==null?void 0:t.rows_deleted)!=null?(this._message={type:"success",text:`Flushed ${t.rows_deleted} rows`},await this._fetchInfo()):this._message={type:"error",text:"Flush failed"}}catch(e){this._message={type:"error",text:`Flush failed: ${e.message}`}}}async _remove(){var t,s;const{data:e}=await m(this.apiBase,"mutation($k: String!, $n: String!) { removePlugin(kind: $k, name: $n) { ok message } }",{k:this.kind,n:this.name});(t=e==null?void 0:e.removePlugin)!=null&&t.ok?(window.history.pushState({},"",`/settings/${this.kind}`),window.dispatchEvent(new PopStateEvent("popstate"))):this._message={type:"error",text:((s=e==null?void 0:e.removePlugin)==null?void 0:s.message)||"Remove failed"}}_switchTab(e){this.activeTab=e;const t=`/settings/${this.kind}/${this.name}`,s=e==="details"?t:`${t}/${e}`;window.history.pushState({},"",s)}async _fetchPreview(e){if(this._selectedTable=e,!e){this._previewRows=null;return}this._previewLoading=!0;const t=this.kind==="schema"?"metrics":this.name,s=await b(this.apiBase,"query($s: String!, $t: String!) { tablePreview(schema: $s, table: $t, limit: 100) }",{s:t,t:e});this._previewRows=s==null?void 0:s.tablePreview,this._previewLoading=!1}_renderData(){var t,s;const e=this._tables||[];if(e.length===0)return n`<p style="color:var(--shenas-text-muted,#888)">No tables synced yet.</p>`;if(!this._selectedTable){const a=(t=this._info)==null?void 0:t.primary_table,i=a&&e.some(r=>r.name===a)?a:(s=e[0])==null?void 0:s.name;i&&this._fetchPreview(i)}return n`
    ...
    `:""}}c(j,"properties",{apiBase:{type:String,attribute:"api-base"},kind:{type:String},name:{type:String},activeTab:{type:String,attribute:"active-tab"},_info:{state:!0},_loading:{state:!0},_message:{state:!0},_tables:{state:!0},_syncing:{state:!0},_transforming:{state:!0},_schemaTransforms:{state:!0},_selectedTable:{state:!0},_previewRows:{state:!0},_previewLoading:{state:!0}}),c(j,"styles",[x,H,C,se,u`
      :host {
        display: block;
      }
      .back {
    ...
    `}}c(W,"properties",{apiBase:{type:String,attribute:"api-base"},source:{type:String},_transforms:{state:!0},_loading:{state:!0},_editing:{state:!0},_editSql:{state:!0},_message:{state:!0},_previewRows:{state:!0},_creating:{state:!0},_newForm:{state:!0},_dbTables:{state:!0},_schemaTables:{state:!0}}),c(W,"styles",[Z,x,I,C,u`
      :host {
        display: block;
      }
      .edit-panel {
