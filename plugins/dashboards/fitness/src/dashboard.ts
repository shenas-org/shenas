...
export class ShenasDashboard extends LitElement {
  ...
  declare _hrv: TimeSeries | null;
  declare _sleep: TimeSeries | null;
  declare _vitals: TimeSeries | null;
  declare _body: TimeSeries | null;
  ...
  _prepTimeSeries(table: Table, valueColumns: string[]): TimeSeries | null {
