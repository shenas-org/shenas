...
describe("categoryColor", () => {
  it("returns a color for known categories", () => {
    ...
    expect(categoryColor("music")).toBe("#e17055");
    expect(categoryColor("meal")).toBe("#fdcb6e");
    expect(categoryColor("sleep")).toBe("#a29bfe");
    expect(categoryColor("finance")).toBe("#00cec9");
  });
