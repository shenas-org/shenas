              ...
              <div class="tab-bar">
                ${this._tabs.map(s=>a`
                  <div class="tab-item ${s.id===this._activeTabId?"active":""}"
                    ...
                    <span>${s.label}</span>
                    <button class="tab-close" @click=${i=>{i.stopPropagation(),this._closeTab(s.id)}}>x</button>
                  </div>
                `)}
